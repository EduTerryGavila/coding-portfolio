...
fac2 n
   ...
   | n<0 = error "No se puede calcular el factorial de un numero negativo" 
	...
	-- o bien (usando "otherwise" y operador * como funci�n prefija):
...
---Mediante encaje de patrones n+k. OJO! La bandera -XNoNPlusKPatterns desactiva la opci�n de patrones n+k. Para activarla: -XNPlusKPatterns:
