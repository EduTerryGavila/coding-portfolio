...
//	}
	//aqui comentamos esta funcion porque hemos modificado la funcion que llama, 
	//para poder usar la clase en la que se apoya fileinfo para tener mas informacion relativa a los ficheros, 
	//entre otros, un lista de los servidores que los tienen publicado,
	//por tanto la funcion 'directoryConnector.getServersSharingThisFile(filenameSubstring);' 
	//no la usamos, sino que usamos esta otra:'getFilenameServersInfo'
	public FileWithPeers getFilenameInfo(String filenameSubstring) {
		return directoryConnector.getFilenameServersInfo(filenameSubstring);
	}
	/**
