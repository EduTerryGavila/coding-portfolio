...
public class PeerMessageOps {
	...
	public static final byte OPCODE_REQUEST_FILE = 0x01;
	public static final byte OPCODE_REQUEST_CHUNK = 0x02;
	...
	public static final byte OPCODE_REQUEST_FILE_ACCEPTED = 0x11;
	public static final byte OPCODE_FILE_NOT_FOUND = 0x12;
	public static final byte OPCODE_CHUNK = 0x13;
	public static final byte OPCODE_REQUEST_CHUNK_OUTOFRANGE = 0x14;
	...
	private static final Byte[] _valid_opcodes = {
			OPCODE_INVALID_CODE,
			OPCODE_REQUEST_FILE,
			OPCODE_REQUEST_CHUNK,
			OPCODE_STOP,
			OPCODE_UPLOAD,
			OPCODE_FILENAME_TO_SAVE,
			OPCODE_REQUEST_FILE_ACCEPTED,
			OPCODE_FILE_NOT_FOUND,
			OPCODE_CHUNK,
			OPCODE_REQUEST_CHUNK_OUTOFRANGE,
